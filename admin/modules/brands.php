...
$items = get_all('brands', 'sort_order ASC, created_at DESC');
$editItem = [];
$isEdit = false;
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right">
                            ...
                            <button onclick="confirmDelete('brands.php?delete=<?= $p['id'] ?>', '<?= h(addslashes($p['name'])) ?>')" class="btn btn-danger btn-sm"><i class="ti ti-trash"></i></button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
