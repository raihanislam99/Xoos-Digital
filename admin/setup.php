...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (!$isRestMode) {
            ...
            $pdo->exec("CREATE TABLE IF NOT EXISTS packages (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, tier VARCHAR(50), tagline VARCHAR(255), price VARCHAR(50), features TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)");
        ...
        if ($pdo->query("SELECT COUNT(*) FROM blog_posts")->fetchColumn() == 0) {
            ...
            $blogStmt->execute(['Why Branding & Identity Design Matters More Than Ever', 'why-branding-matters', '<h2>The Foundation of Brand Recognition</h2><p>Your brand identity is the visual voice of your business.</p>', 'Why Branding Matters | Xoos Digital', 'Learn why professional branding is crucial for business growth.', 'branding, identity design, logo design', 'images/Xoos_Digital_Facebook_Cover_Image.jpg']);
            $blogStmt->execute(['The Complete Guide to Building a High-Converting Website', 'high-converting-website-guide', '<h2>What Makes a Website Convert?</h2><p>A high-converting website guides visitors toward action.</p>', 'High-Converting Website Guide | Xoos Digital', 'Learn how to build a website that converts.', 'web development, wordpress, conversion optimization', 'images/Xoos_Digital_Facebook_Cover_Image.jpg']);
            $blogStmt->execute(['Effective SEO & Digital Marketing Strategies to Grow Your Brand', 'seo-digital-marketing-strategies', '<h2>The Power of Organic Growth</h2><p>SEO is the most cost-effective way to drive long-term traffic.</p>', 'SEO & Marketing Strategies | Xoos Digital', 'Discover effective SEO and digital marketing strategies.', 'seo, digital marketing, social media', 'images/Xoos_Digital_Facebook_Cover_Image.jpg']);
            $blogStmt->execute(['How to Choose the Right Color Palette for Your Brand', 'choose-brand-color-palette', '<h2>Color Psychology in Branding</h2><p>Colors evoke emotions. Blue conveys trust. Red creates urgency.</p>', 'Choose Your Brand Color Palette | Xoos Digital', 'Learn how to choose the perfect color palette.', 'brand colors, color palette, brand identity', 'images/Xoos_Digital_Facebook_Cover_Image.jpg']);
            $blogStmt->execute(['The Ultimate Guide to WooCommerce SEO for Online Stores', 'woocommerce-seo-guide', '<h2>Why WooCommerce SEO Matters</h2><p>WooCommerce powers millions of online stores.</p>', 'WooCommerce SEO Guide | Xoos Digital', 'Complete guide to optimizing your WooCommerce store.', 'woocommerce, seo, ecommerce', 'images/Xoos_Digital_Facebook_Cover_Image.jpg']);
            $blogStmt->execute(['Video Marketing Trends to Watch in 2025', 'video-marketing-trends-2025', '<h2>The Rise of Short-Form Video</h2><p>Short-form video dominates social media algorithms.</p>', 'Video Marketing Trends 2025 | Xoos Digital', 'Discover the top video marketing trends.', 'video marketing, social media, reels', 'images/Xoos_Digital_Facebook_Cover_Image.jpg']);
